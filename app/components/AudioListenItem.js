...
const renderPlayPauseIcon = isPlaying => {
    ...
    return <Entypo name="controller-play" size={24} color={color.ACTIVE_FONT} />;//puse icon
}

const  AudioListenItem = ({title,
    duration, onOptionPress, onAudioPress,
...
export  default AudioListenItem;